    ...
    return new Promise(function (resolve, reject) {
      ...
      withStore('readonly', function (store) {
        ...
        req.onerror = function getItemOnError() {
          reject(new Error('Error in asyncStorage.getItem(): ' + req.error.name));
        };
      }, reject);
    });
  }
    ...
    return new Promise(function (resolve, reject) {
      withStore('readwrite', function (store) {
        ...
        req.onerror = function setItemOnError() {
          reject(new Error('Error in asyncStorage.setItem(): ' + req.error.name));
        };
      }, reject);
    });
  }
    ...
    return new Promise(function (resolve, reject) {
      withStore('readwrite', function (store) {
        ...
        req.onerror = function removeItemOnError() {
          reject(new Error('Error in asyncStorage.removeItem(): ' + req.error.name));
        };
      }, reject);
    });
  }
    ...
    return new Promise(function (resolve, reject) {
      withStore('readwrite', function (store) {
        ...
        req.onerror = function clearOnError() {
          reject(new Error('Error in asyncStorage.clear(): ' + req.error.name));
        };
      }, reject);
    });
  }
    ...
    return new Promise(function (resolve, reject) {
      ...
      withStore('readonly', function (store) {
        ...
        req.onerror = function lengthOnError() {
          reject(new Error('Error in asyncStorage.length(): ' + req.error.name));
        };
      }, reject);
    });
  }
